...
import (
	...
	"github.com/ninjadotorg/uncommons/common/math"
	"github.com/ninjadotorg/uncommons/consensus/ethash"
	"github.com/ninjadotorg/uncommons/core"
	"github.com/ninjadotorg/uncommons/core/rawdb"
...
//
// https://github.com/ninjadotorg/uncommons/wiki/Management-APIs#personal_sign
...
//
// https://github.com/ninjadotorg/uncommons/wiki/Management-APIs#personal_ecRecover
...
func submitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	fmt.Println(tx.MarshalJSON())
	if err := b.SendTx(ctx, tx); err != nil {
		return common.Hash{}, err
	}
	/* gunc-note: info of transaction */
	if tx.To() == nil {
