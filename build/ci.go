...
import (
	...
	"github.com/ninjadotorg/uncommons/internal/build"
	"github.com/ninjadotorg/uncommons/params"
	sv "github.com/ninjadotorg/uncommons/swarm/version"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ninjadotorg/uncommons/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "--tags", "ios", "-v", "github.com/ninjadotorg/uncommons/mobile")
