...
import (
	...
	"github.com/ninjadotorg/uncommons/accounts/abi/bind"
	"github.com/ninjadotorg/uncommons/common"
	"github.com/ninjadotorg/uncommons/contracts/chequebook"
	"github.com/ninjadotorg/uncommons/contracts/ens"
	"github.com/ninjadotorg/uncommons/ethclient"
	...
	"github.com/ninjadotorg/uncommons/p2p/protocols"
	"github.com/ninjadotorg/uncommons/params"
	"github.com/ninjadotorg/uncommons/rpc"
	"github.com/ninjadotorg/uncommons/swarm/api"
	httpapi "github.com/ninjadotorg/uncommons/swarm/api/http"
	"github.com/ninjadotorg/uncommons/swarm/fuse"
	"github.com/ninjadotorg/uncommons/swarm/log"
	"github.com/ninjadotorg/uncommons/swarm/network"
	"github.com/ninjadotorg/uncommons/swarm/network/stream"
	"github.com/ninjadotorg/uncommons/swarm/pss"
	"github.com/ninjadotorg/uncommons/swarm/state"
	"github.com/ninjadotorg/uncommons/swarm/storage"
	"github.com/ninjadotorg/uncommons/swarm/storage/mock"
	"github.com/ninjadotorg/uncommons/swarm/storage/mru"
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	addr := &network.BzzAddr{
		...
		UAddr: []byte(discover.NewNode(nodeID, net.IP{127, 0, 0, 1}, 31313, 31313).String()),
	}
